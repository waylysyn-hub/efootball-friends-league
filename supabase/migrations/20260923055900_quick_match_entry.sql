-- Allow admin score-only entry without rewriting existing matches or goal events.
begin;
...
begin
  ...
  -- An empty array explicitly means score-only; nonempty details must be complete.
