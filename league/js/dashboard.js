...
export function renderDashboard() {
  ...
  document.getElementById('dashCurrentSeason').textContent =
    activeSeason ? `${displaySeason(activeSeason.name)} — نشط` : "لا يوجد موسم نشط";
  ...
  // Total matches
  setStatCard('sc-matches', seasonMatches.length.toString(), "هذا الموسم");
...
export function setStatCard(id, value, sub) {
  ...
  if (valEl) valEl.textContent = displayName(value);
